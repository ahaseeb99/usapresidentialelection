...
//General settings
  ...
  //STATES WITH POTENTIAL DRAW
   ...
   AZ: {
    ...
    color: "grey",
    hover_color: "green",
    description: "11 Electoral votes <br> Win probability : Draw"
  },
  GA: {
    name: "Georgia",
    color: "grey",
    hover_color: "green",
    description: "16 Electoral votes <br> Win probability : Draw"
  },
  MI: {
    name: "Michigan",
    color: "grey",
    hover_color: "green",
    description: "15 Electoral votes <br> Win probability : Draw"
  },
  NV: {
    name: "Nevada",
    color: "grey",
    hover_color: "green",
    description: "6 Electoral votes <br> Win probability : Draw"
  },
  PA: {
    name: "Pennsylvania",
    color: "grey",
    hover_color: "green",
    description: "19 Electoral votes <br> Win probability : Draw"
  },
  WI: {
    name: "Wisconsin",
    color: "grey",
    hover_color: "green",
    description: "10 Electoral votes <br> Win probability : Draw"
  },
...
var republicansVotes = 235;
var democratsVotes = 226;
var drawVotes = 77;
