...
//General settings
  ...
  AZ: {
    ...
    color: "#033A90",
    hover_color: "green",
    description: "11 Electoral votes <br> Likely to win : <img src='/public/images/R.png'style='width: 30px; height: 30px;'/"
  },
  GA: {
    name: "Georgia",
    color: "#DC0B10",
    hover_color: "green",
    description: "16 Electoral votes <br> Likely to win : <img src='/public/images/D.png'style='width: 30px; height: 30px;'/"
  },
  MI: {
    name: "Michigan",
    color: "#DC0B10",
  ...
  NV: {
    ...
    color: "#033A90",
    hover_color: "green",
    description: "6 Electoral votes <br> Likely to win : <img src='/public/images/R.png'style='width: 30px; height: 30px;'/"
  },
  PA: {
    name: "Pennsylvania",
    color: "#033A90",
    hover_color: "green",
    description: "19 Electoral votes <br> Likely to win : <img src='/public/images/D.png'style='width: 30px; height: 30px;'/"
  },
  WI: {
    name: "Wisconsin",
    color: "#033A90",
    hover_color: "green",
    description: "10 Electoral votes <br> Likely to win : <img src='/public/images/R.png'style='width: 30px; height: 30px;'/"
  },
  ...
  //OTHER STATES
    ...
    invisible_1: {
		...
		color: "#033A90",
		hover_color: "green",
		description: "2 Electoral votes <br> Win probability: <img src='./map_images/D.png'style='width: 30px; height: 30px;'/>",
    },
    invisible_2: {
      name: "invisible_2",
      inactive: "no",
	  ...
	  color: "#033A90", 
	  hover_color: "green",
	  description: "1 Electoral vote <br> Win probability: <img src='./map_images/D.png'style='width: 30px; height: 30px;'/>",
     },
    invisible_3: {
      inactive: "no",
	  ...
	  color: "#DC0B10", 
	  hover_color: "green",
	  description: "1 Electoral vote <br> Win probability: <img src='./map_images/R.png'style='width: 30px; height: 30px;'/>",
    },
    invisible_4: {
      inactive: "no",
	  ...
	  color: "#DC0B10",  
	  hover_color: "green",
	  description: "2 Electoral votes <br> Win probability: <img src='./map_images/R.png'style='width: 30px; height: 30px;'/>",
    },
    invisible_5: {
      inactive: "no",
    ...
    invisible_7: {
	  ...
	  color: "#DC0B10",
	  hover_color: "green",
	  description: "1 Electoral vote <br> Wwin probability: <img src='./map_images/R.png'style='width: 30px; height: 30px;'/>",
    },
  },
...
var republicansVotes = 266;
var democratsVotes = 272;
