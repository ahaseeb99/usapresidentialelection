...
@section('section-one')
    <script src="{{ asset('public/dem-map/DEM-Sc1/mapdata-DEM-Sc1.js') }}"></script>
    <script src="{{ asset('public/dem-map/DEM-Sc1/usmap.js') }}"></script>
    <div class="container">
        <?php $language = session()->get('locale') ?>
        @if($language == 'fr')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Scénario 1</span> : Démocrates  <br />
            </h2>
        @elseif($language == 'es')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Escenario 1</span> : Demócratas  <br />
            </h2>
        @else
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">@lang('words.Democrats')</span> @lang('words.scenario') 1 <br />
            </h2>
        @endif
        <div class="vote--sec">
            ...
            @if($language == 'es')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 1 para los Demócratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @elseif($language == 'pt')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 1 para os Democratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @else
                ...
                @lang('words.look') <br />
                <span class="primary-color">
                    @lang('words.scenario') 1 @lang('words.for DEM').
                </span>
                @lang('words.look-2')
                </h2>
            @endif
    ...
    <div class="container">
        <div class="left">
            ...
            <div class="result--notice pb-120">
                ...
                @guest
                    <a href="{{ route('register', ['redirect' => url()->current()]) }}" class="btn btn-vote mb-3">@lang('words.Login to Vote')</a>
                @else
                ...
                <h3 class="text-center">
                    @lang('words.vote:h1')
                    <span class="primary-color">
                        @lang('words.scenario') 1</span>, <br>
                        
                        <a href="{{ url('/democrat/scenario-2/') }}" class="result--next">@lang('words.clickhere')</a>
                        
                        @lang('words.to go to')
                    <span class="primary-color">
                        @lang('words.scenario') 2
                    </span>
                </h3>
            </div>
        </div>
