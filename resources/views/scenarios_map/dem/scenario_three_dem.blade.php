...
@section('section-one')
    <script src="{{ asset('public/dem-map/DEM-Sc3/mapdata-DEM-Sc3.js') }}"></script>
    <script src="{{ asset('public/dem-map/DEM-Sc3/usmap.js') }}"></script>

    <div class="container">
        <?php $language = session()->get('locale') ?>
        @if($language == 'fr')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Scénario 3</span> : Démocrates  <br />
            </h2>
        @elseif($language == 'es')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Escenario 3</span> : Demócratas  <br />
            </h2>
        @else
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">@lang('words.Democrats')</span> @lang('words.scenario') 3 <br />
            </h2>
        @endif
        <div class="vote--sec">
            ...
            @if($language == 'es')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 3 para los Demócratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @elseif($language == 'pt')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 3 para os Democratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @else
                ...
                @lang('words.look') <br />
                <span class="primary-color">
                    @lang('words.scenario') 3 @lang('words.for DEM').
                </span>
                @lang('words.look-2')
                </h2>
            @endif
    ...
    <div class="container">
        ...
        <div class="result--notice pb-120">
            ...
            <h3 class="text-center">
                ...
                <span class="primary-color">
                    Scenario 3</span>,<br>
                    <a href="{{ url('/democrat/scenario-4/') }}" class="result--next">@lang('words.clickhere')</a>
                    @lang('words.to go to')
                <span class="primary-color">
                    @lang('words.scenario') 4
                </span>
            </h3>
            <a href="{{ url('/democrat/scenario-2/') }}" class="result--next--oppo">@lang('words.previous')</a>
        </div>
