...
@section('section-one')
    <script src="{{ asset('public/dem-map/DEM-Sc9/mapdata-DEM-Sc9.js') }}"></script>
    <script src="{{ asset('public/dem-map/DEM-Sc9/usmap.js') }}"></script>

    <div class="container">
        <?php $language = session()->get('locale') ?>
        @if($language == 'fr')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Scénario 9</span> : Démocrates  <br />
            </h2>
        @elseif($language == 'es')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">Escenario 9</span> : Demócratas  <br />
            </h2>
        @else
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="primary-color">@lang('words.Democrats')</span> @lang('words.scenario') 9 <br />
            </h2>
        @endif
        <div class="vote--sec">
                ...
                <div class="countries-flags voting--states two-cols">
                    <div class="county-flag">
                        ...
                        <h3>
                            ...
                            <span class="primary-color">PA: 19</span>
                        </h3>
                    </div>
            ...
            <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--two" style="font-weight: 700;">
                <span class="black-color" style="font-weight: 300">= 272</span>
                <span class="primary-color">
                    @lang('words.Electoral Votes')
                </span>
            </h2>
            @if($language == 'es')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 9 para los Demócratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @elseif($language == 'pt')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="primary-color">
                        @lang('words.scenario') 9 para os Democratas.
                    </span>
                    @lang('words.look-2')
                </h2>
            @else
                ...
                @lang('words.look') <br />
                <span class="primary-color">
                    @lang('words.scenario') 9 @lang('words.for DEM').
                </span>
                @lang('words.look-2')
                </h2>
            @endif
...
@section('section-two')
    <div class="container">
        ...
        <div class="result--notice pb-120">
            ...
            <?php $language = session()->get('locale') ?>
            @if($language == 'fr')
                <a href="{{ route('login', ['redirect' => url()->current()]) }}" class="btn btn-vote mb-3">Je choisis ce Scénario</a>
            @else
            ...
            <h3 class="text-center">
                @lang('words.vote:h1')
                <span class="primary-color">
                    @lang('words.scenario') 9</span>,<br>
                    <a href="{{ url('/scenarios') }}" class="result--next">@lang('words.clickhere')</a>
                @if($language == 'es')
            ...
            <a href="{{ url('/democrat/scenario-8/') }}" class="result--next--oppo">@lang('words.previous')</a>
        </div>
