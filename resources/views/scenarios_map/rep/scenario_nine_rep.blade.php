...
@section('section-one')
    <script src="{{ asset('public/rep-map/REP-Sc9/mapdata-REP-Sc9.js') }}"></script>
    <script src="{{ asset('public/rep-map/REP-Sc9/usmap.js') }}"></script>

    <div class="container">
        <?php $language = session()->get('locale') ?>
        @if($language == 'fr')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                @lang('words.scenario') 9 : <span class="secondary-color">@lang('words.Republicans')</span> <br />
            </h2>
        @elseif($language == 'es')
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                @lang('words.scenario') 9 : <span class="secondary-color">@lang('words.Republicans')</span> <br />
        ...
        @else
            <h2 class="pt-95 text-center font-48 left--block--heading" style="font-weight: 700;">
                <span class="secondary-color">@lang('words.Republicans')</span> @lang('words.scenario') 9 <br />
            </h2>
        @endif
        <div class="vote--sec">
            @if($language == 'fr')
            ...
            <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                ...
                @lang('words.look') <br />
                <span class="secondary-color">
                    @lang('words.scenario') 9 @lang('words.for REP')
                </span>
                @lang('words.look-2')
            @elseif($language == 'es') 
                @lang('words.look') <br />
            ...
            @elseif($language == 'pt')
                <h2 class="pb-52 text-center font-48 pt-52 vote--sec--heading--three">
                    @lang('words.look') <br />
                    <span class="secondary-color">
                        @lang('words.scenario') 9 para os Republicanos.
                    </span>
                    @lang('words.look-2')
                </h2>
            @else 
    ...
    <div class="container">
        ...
        <div class="result--notice pb-120">
            ...
            <h3 class="text-center">
                @lang('words.vote:h1')
                <span class="secondary-color">
                    @lang('words.scenario') 9</span>,<br><a href="{{ url('/republican/scenario-10/') }}" class="result--next--oppo">@lang('words.clickhere')</a> @lang('words.to go to')
                <span class="secondary-color">
                    @lang('words.scenario') 10
                </span>
            </h3>

            <a href="{{ url('/republican/scenario-8/') }}" class="result--next">@lang('words.previous')</a>
        </div>
